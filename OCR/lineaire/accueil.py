...
from OCR.programmes.ref_produit import OCR_ref_produit
from OCR.programmes.type_produit import OCR_type_produit
...
class HomePageL(QDialog):
    def __init__(self):
        super(HomePageL, self).__init__()
    ...
    def modele_ia_lineaire(self):
        ...
        self.comparaison.compare_lineaire(self.image_prod_path, modele_prod)
        self.comparaison.compare_eti_lineaire()
        self.comparaison.draw_boxes_on_image_lineaire(self.image_prod_path,
